  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="space-y-12">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">
            Business Term Ownership
          </h2>
          <p className="mt-1 text-sm leading-6 text-gray-600">
            Provide further details for the ownership & governance of the Business Term
          </p>

          <div className="mt-10 grid grid-cols-1 gap-x-1 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <select
                  {...register("owner.type")}
                  autoComplete="owner type"
                  className="block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                >
                  <option>Technical Owner</option>
